...
<span style="font-size:x-small;"> Legal note: By using this extension you’ll share pseudo-anonymized usage metrics with semgrep.dev. Rules are also pulled from the Semgrep Registry. Our [terms](https://semgrep.dev/terms) and [privacy policy](https://semgrep.dev/privacy) apply. </span>
